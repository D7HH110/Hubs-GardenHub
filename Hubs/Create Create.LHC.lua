-- Create.SKY.lua - Spawn Pet مع Dropdown للاختيار + الوزن + العمر + Hide/Show GUI
...
Title.Text = "🌱 Create.SKY - Spawn Pet"
Title.TextColor3 = Color3.new(1,1,1)
Title.BackgroundColor3 = Color3.fromRGB(25,25,25)
Title.Parent = Frame

-- Dropdown للاختيار من الحيوانات الموجودة في workspace و ReplicatedStorage
